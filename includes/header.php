...
<head>
  ...
  $root = str_repeat('../', substr_count(trim($_SERVER['PHP_SELF'], '/'), '/') );
  ?>
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="side-nav" id="sideNav">
        ...
        <div class="nav-group">
          ...
          <ul class="sublist">
            <li><a href="<?= $root ?>contents/agenda-calendar/calendar.php?"
                class="nav-link">Event Calendar</a></li>
            <li><a href="<?= $root ?>contents/agenda-calendar/agenda_builder.php"
                class="nav-link">Agenda Builder</a></li>
            <li><a href="<?= $root ?>contents/agenda-calendar/special_session.php"
                class="nav-link">Special Session</a></li>
            <li><a href="<?= $root ?>contents/agenda-calendar/alerts.php?"
                class="nav-link">Deadline and Reminders</a></li>
          </ul>
        </div>
